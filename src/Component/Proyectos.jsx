...
export default function Proyectos () {
    return(
      <section id="proyectos" className="proyectos-recientes seccion-clara d-flex flex-column">
        ...
        <Proyect UrlImg={imagenes.Proyect6} alt='proyecto 6' nameProyect='Calculadora' DireccionProyectRepo='https://github.com/AldairZambrano/CaluladoraFree' DireccionProyectweb='https://calculadora-free.netlify.app/'></Proyect>
